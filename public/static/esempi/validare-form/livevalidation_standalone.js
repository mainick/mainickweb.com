...
LiveValidationForm.getInstance = function (element) {
  ...
  if (!window['LiveValidationForm_' + element.id])
    window['LiveValidationForm_' + element.id] = new LiveValidationForm(element)
...
var Validate = {
  ...
  Length: function (value, paramsObj) {
    ...
    var tooShortMessage =
      paramsObj.tooShortMessage || 'Must not be less than ' + minimum + ' characters long!'
    var tooLongMessage =
      paramsObj.tooLongMessage || 'Must not be more than ' + maximum + ' characters long!'
    switch (true) {
      case is !== null:
  ...
  Confirmation: function (value, paramsObj) {
    ...
    var match = paramsObj.match.nodeName
      ? paramsObj.match
