...
function ListLayout({ posts , title: title1 , initialDisplayPosts =[] , pagination  }) {
    ...
    const filteredBlogPosts = posts.filter((frontMatter)=>{
        let searchContent = frontMatter.title + frontMatter.excerpt;
        if (frontMatter.tag) searchContent += frontMatter.tag.join(' ');
        if (frontMatter.tags) searchContent += frontMatter.tags.join(' ');
                                                    ...
                                                    /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                                                        children: [
                                                            ...
                                                            /*#__PURE__*/ (0,jsx_runtime_.jsxs)("div", {
                                                                ...
                                                                children: [
                                                                    tags && tags.map((tag)=>/*#__PURE__*/ jsx_runtime_.jsx(Tag/* default */.Z, {
                                                                            text: tag
                                                                        }, tag)
                                                                    ),
                                                                    tag1 && tag1.map((tag)=>/*#__PURE__*/ jsx_runtime_.jsx(Tag/* default */.Z, {
                                                                            text: tag
                                                                        }, tag)
                                                                    )
                                                                ]
