...
async function getStaticProps() {
    const policyDetails = await (0,_lib_mdx__WEBPACK_IMPORTED_MODULE_2__/* .getFileBySlug */ .x7)('', 'privacy');
    return {
        props: {
            policyDetails
        }
...
function Privacy({ policyDetails  }) {
...
var __webpack_exports__ = __webpack_require__.X(0, [730,664,675,152,59,373,590,717,795,412,968,620], () => (__webpack_exec__(533)));
